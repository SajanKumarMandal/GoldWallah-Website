...
export default function AuthLayout({ eyebrow, title, description, children }) {
  return (
    <section className="bg-(--gw-color-green) px-4 py-8 text-(--gw-color-cream) sm:px-6 md:py-12 lg:px-12">
      <div className="mx-auto grid w-full max-w-7xl items-center gap-8 lg:min-h-[calc(100vh-112px)] lg:grid-cols-[0.95fr_1.05fr] xl:grid-cols-[1.02fr_0.98fr]">
        ...
        <div className="mx-auto w-full max-w-2xl lg:max-w-none">{children}</div>
      </div>
    </section>
  );
}
